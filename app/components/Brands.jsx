        ...
        <section className='min-h-[400px] flex items-center justify-center flex-col '>
            ...
            <div className='flex flex-col gap-5 items-center'>
                ...
                <div className='mr-[200px] flex flex-row items-center gap-2 bg-[var(--gray)] py-3 rounded-xl px-5 max-w-max'>
                    <img src={profile1.src} alt='' className='w-12 h-12 rounded-full bg-[var(--black)] object-cover' />
                    <img src={profile2.src} alt='' className='w-12 h-12 rounded-full bg-[var(--black)] object-cover' />
                    <img src={profile3.src} alt='' className='w-12 h-12 rounded-full bg-[var(--black)] object-cover' />
                    <img src={profile4.src} alt='' className='w-12 h-12 rounded-full bg-[var(--black)] object-cover' />
                </div>
                ...
                <div className='space-y-10 text-center'>
                    ...
                    <div className='flex flex-row items-start'>
                        <h2>Us With Using</h2>
                        <div
                            className='relative w-[250px] h-[200px] rounded-[30px] bg-[var(--gray)] mt-[80px] mx-[-20px]'>
                            <div className='absolute top-[-80px] w-[100px] h-[100px] left-1/2 transform -translate-x-1/2 bg-[var(--gray)] rounded-[30px] flex items-center justify-center'>
            ...
            {/* brand logos */}
            <div className='mt-[150px] w-full bg-[var(--black)] rounded-[30px] h-[150px] flex items-center justify-between px-20'>
                {/* <div
