  ...
  return (
    <section className='relative min-h-[400px] mx-4 md:mx-0 rounded-[30px] flex flex-col  sm:flex-row items-center gap-10 justify-between bg-[var(--black)] text-[var(--gray)]'>
      ...
      <div className='flex-1 mt-10 sm:mt-0 flex flex-col gap-5 justify-center items-center sm:items-start'>
        <Logo type='footer' />
        <h4 className='text-neutral-500 text-center sm:text-start'><TextAnimation text="Discover the power of our and rewarding credit cards" /></h4>
        <Button><TextAnimation text="Enter email address" /></Button>
      ...
      <div className='mt-[50px] flex-1 flex flex-col gap-10 items-center justify-center'>
        <div className='flex flex-wrap gap-5 lg:gap-10 md:flex-row items-start justify-center'>
          <div className='space-y-5 text-center'>
            <h4><TextAnimation text="About us" /></h4>
            <h4><TextAnimation text="Products" /></h4>
            <h4><TextAnimation text="useful Links" /></h4>
          </div>
          <div className='space-y-5 text-center'>
            <h4><TextAnimation text="About us" /></h4>
            <h4><TextAnimation text="Products" /></h4>
